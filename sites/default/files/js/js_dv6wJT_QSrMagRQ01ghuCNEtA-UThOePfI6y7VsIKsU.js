...
$(document).ready(function(){
    ...
    $('#lend_borrow-nav a[data-toggle="pill"]').click(function(){
        var targetTab = $(this).attr("data-target-tab");
        $(".main-tab-content > .tab-pane").removeClass("show active");
    ...
    $(".menu-item-has-childrens > a").click(function(e){
        e.preventDefault();
        $(this).parent().toggleClass("active");
        $(this).parent().find(".sub_menu").slideToggle();
        // $(this).parent().siblings("li").find(".sub_menu").slideUp();
        // $(this).parent().siblings("li").removeClass("active");
    });

    $('.three_slide_carousal').slick({
        dots: true,
        infinite: true,
        arrows: false,
        speed: 500,
    ...
    $(".footer .accordian .heading").click(function(){
      ...
      $(this).parent().toggleClass("active");
      $(this).parents(".column").siblings(".column").find("ul").slideUp();
      $(this).parents(".column").siblings(".column").find(".accordian").removeClass("active");
    });
...
$(window).load(function(){
  $(".slick-slider").each(function(){
    var navLength = $(this).find(".slick-dots li").length;
    if(navLength < 2){
